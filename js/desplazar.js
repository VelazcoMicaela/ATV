		...
		$("#instructor_actual").toggle(750, function() {
			...
			var text = "<h2 class=\"sec secinst\">SabonNim</h2>"
				...
				+ "<div class=\"secsed\">" 
					...
					+ "<h4 class=\"domi\">Lun Mie Vie 18hs a 19.20hs</h4>"
	...
	$("#carita2").click(function() {
		$("#instructor_actual").toggle(750, function() {
			...
			var text = "<h2 class=\"sec secinst\">Sabon</h2>"
				...
				+ "<div class=\"secsed\">" 
					+ "<h4 class=\"horario\">HORARIO</h4>"
					+ "<h4 class=\"domi\">Lun Mie 19.30hs a 21hs Vie 18hs a 20hs</h4>"
					+ "<h4>Sede Quilmes Soc. de Fom. Ameghino</h4>"
				+ "</div>"
			+ "</div>"
			document.getElementById("instructor_actual").innerHTML = text;
			$("#instructor_actual").toggle(750);
		...
		$("#instructor_actual").toggle(750, function() {
			...
			var text = "<h2 class=\"sec secinst\">Sabon</h2>"
				...
				+ "<div class=\"secsed\">" 
					+ "<h4 class=\"horario\">HORARIO</h4>"
					+ "<h4 class=\"domi\">Lun Mie 18hs a 19.30hs Vie 18hs a 20hs</h4>"
					+ "<h4>Sede Quilmes Soc. de Fom. Ameghino</h4>"
				+ "</div>"
			+ "</div>"
			document.getElementById("instructor_actual").innerHTML = text;
		...
		$("#instructor_actual").toggle(750, function() {
			...
			var text = "<h2 class=\"sec secinst\">Sabon</h2>"
				...
				+ "<div class=\"secsed\">" 
					...
					+ "<h4 class=\"domi\">Junior 18.30hs a 19.30hs Infantil 19.30hs a 21hs</h4>"
